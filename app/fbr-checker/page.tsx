...
export default function FBRCheckerPage() {
  ...
  const shareText = result
    ? `I checked FBR compliance for ${businessName} on Phelix ERP and scored ${result.score}/100 (${result.risk} Risk). Check your business compliance free: https://phelixerp.com/fbr-checker`
    : "";
